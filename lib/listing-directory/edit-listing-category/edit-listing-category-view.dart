...
class editListingCategoryWidget extends StatefulWidget {
  ...
  const editListingCategoryWidget({Key key, this.id, this.name}): super(key: key);

  @override
  _editListingCategoryWidgetState createState() => _editListingCategoryWidgetState();
}
...
class _editListingCategoryWidgetState extends State<editListingCategoryWidget> {
  ...
  EditSingleListingCategoryMan editListingCategoriesServives = EditSingleListingCategoryMan();
  @override
  void initState() {
    super.initState();
