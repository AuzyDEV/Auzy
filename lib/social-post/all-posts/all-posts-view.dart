                  ...
                  child: Column(
                    children: [
                      TabBar(
                        ...
                        unselectedLabelColor: FlutterAppTheme.of(context).primaryText,
                                              ...
                                              builder:(context, snapshot) {
                                                if (snapshot.hasData) {
                                                  return ListView.builder(
                                                    ...
                                                    itemBuilder: (_,index) =>
                                                      Padding(
                                                        padding: EdgeInsetsDirectional.fromSTEB(9, 8, 9,8),
                                                        child:Container(
                                                          decoration:BoxDecoration(
                                                          ...
                                                          child: Column(
                                                            children: [
                                                              Padding(
                                                                padding: EdgeInsetsDirectional.fromSTEB( 2, 5, 2, 8),
                                                                child: Row(
                                                                  mainAxisSize: MainAxisSize.max,
                                                                  children: [
                                                                    Card(
