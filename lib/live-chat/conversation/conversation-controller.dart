...
class MessageMan {
  static Future uploadMessage(String idUser, String message, String currentUserId) async {
    final refMessages = FirebaseFirestore.instance.collection('chats/$currentUserId/discussions/$idUser/messages');
  ...
  static Stream<List<Message>> getMessages(String idUser, String currentUserId) =>
    FirebaseFirestore.instance.collection('chats/$currentUserId/discussions/$idUser/messages').orderBy(MessageField.createdAt, descending: true).snapshots().transform(Utils.transformer(Message.fromJson));
