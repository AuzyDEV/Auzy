...
class medecineDetailsWidget extends StatefulWidget {
  final String id;
  const medecineDetailsWidget({Key key, this.id}) : super(key: key);

  @override
  _medecineDetailsWidgetState createState() => _medecineDetailsWidgetState();
}

class _medecineDetailsWidgetState extends State<medecineDetailsWidget> {
  ...
  void initState() {
    super.initState();
    _getFutureRoleValue();
    _futureMedecine = apimed.getMedecineDetails(widget.id);
    print(widget.id);
  }
